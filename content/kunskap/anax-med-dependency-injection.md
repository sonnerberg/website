...
Vi jobbar vidare med REM Servern och använder oss av begreppen dependency injection och lazy loading för att bygga vidare på tjänsten och att bättre integrera den i ramverket Anax.

Det blir en övning i refactoring av kod och resultatet blir förhoppningsvis kod som blir enklare att underhålla och vidareutveckla.
