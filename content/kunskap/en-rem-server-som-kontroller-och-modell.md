...
Vi studerar ett exempel av en REM Server som är byggd i Anax. Större delen av koden ligger i samma fil där routerna skapas och vi försöker strukturera om koden genom att jobba med kontroller och modeller i MVC.

Det blir en övning i refactoring av kod som förhoppningsvis skrivs om på ett mer strukturerat sätt som i längden blir enklare att underhålla och vidareutveckla.
...
Du har läst artikeln "[Bygg ett ramverkslöst ramverk](kunskap/bygg-ett-ramverkslost-ramverk)".
