...
category: oopython
revision:
    "2017-12-08": (A, aar) Första versionen.
...
...
Du har jobbat igenom artiklarna "[Kom igång med objekt](kunskap/kom-igang-med-objekt)" och "[Klass relationer](kunskap/klass-relationer)" och gjort lab1, "[Python med objekt och klasser](uppgift/python-objekt-och-klasser)".
